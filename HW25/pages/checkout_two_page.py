...
class CheckoutTwoPage(BasePage):
    ...
    def is_item_correct(self):
        return self.is_element_text_correct(self.item_name, 'Sauce Labs Bike Light')
    ...
    def is_navigate_to_checkout_complete_successful(self):
        url_check = self.is_url_correct(Env.URL_CheckoutComplete)
        title_check = self.is_element_text_correct(self.redirect_page_title, 'Checkout: Complete!')
